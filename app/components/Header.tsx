...
import { Trophy, Menu, X, Facebook, Twitter, Instagram, Youtube } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-10">
            ...
            <div className="flex items-center space-x-2">
              <a href="#" className="w-8 h-8 bg-slate-700 hover:bg-yellow-500 transition rounded flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link href="/" className="relative text-gray-300 hover:text-white transition font-semibold text-base tracking-wide whitespace-nowrap group">
                Home
              ...
              <Link href="/about" className="relative text-gray-300 hover:text-white transition font-semibold text-base tracking-wide whitespace-nowrap group">
                About Us
                <span className="absolute -bottom-1 left-0 w-full h-1 bg-yellow-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
              </Link>
              
              <Link href="/programmes" className="relative text-gray-300 hover:text-white transition font-semibold text-base tracking-wide whitespace-nowrap group">
                Programmes
                <span className="absolute -bottom-1 left-0 w-full h-1 bg-yellow-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
              </Link>
              
              <Link href="/coaches" className="relative text-gray-300 hover:text-white transition font-semibold text-base tracking-wide whitespace-nowrap group">
                Our Coaches
                <span className="absolute -bottom-1 left-0 w-full h-1 bg-yellow-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
              </Link>
              
              <div className="relative group">
                <button className="relative text-gray-300 hover:text-white transition font-semibold flex items-center text-base tracking-wide whitespace-nowrap">
                  Academy
              ...
              <Link href="/contact" className="relative text-gray-300 hover:text-white transition font-semibold text-base tracking-wide whitespace-nowrap group">
                Contact Us
                <span className="absolute -bottom-1 left-0 w-full h-1 bg-yellow-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
              </Link>
            </nav>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-slate-800 border-t border-yellow-500/20">
          <nav className="px-4 py-6 space-y-2">
            ...
            <Link href="/contact" className="block text-gray-300 h
            over:text-white hover:bg-slate-700/50 transition-all font-semibold py-3 px-4 rounded-lg text-base" onClick={() => setMobileMenuOpen(false)}>Contact Us</Link>
          </nav>
        </div>
      )}
    </header>
