...
export default function AboutUsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-slate-900 pt-24 pb-16 lg:pt-40 lg:pb-32 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className={`transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
              <div className="inline-flex items-center space-x-2 bg-yellow-500/10 border border-yellow-500/20 rounded-full px-4 py-2 mb-6">
                <Award className="h-4 w-4 lg:h-5 lg:w-5 text-yellow-500" />
                <span className="text-xs lg:text-sm font-semibold text-yellow-500 tracking-wide">ABOUT NEXTPRO AFRICA FA</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3 lg:gap-4">
                <button className="group bg-yellow-500 hover:bg-yellow-600 text-slate-900 px-6 py-3 lg:px-8 lg:py-4 rounded-lg font-bold text-sm lg:text-base transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center space-x-2">
            ...
            <div className={`transition-all duration-1000 delay-300 ${heroVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
              <div className="relative mt-8 lg:mt-0">
                ...
                <div className="absolute -bottom-4 -right-4 w-32 h-32 lg:w-48 lg:h-48 bg-yellow-500/20 rounded-2xl -z-10" />
                <div className="absolute -top-4 -left-4 w-24 h-24 lg:w-32 lg:h-32 bg-blue-500/20 rounded-2xl -z-10" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Our Story Section - Fixed for mobile */}
      <section id="story-section" className="py-16 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className={`transition-all duration-1000 ${storyVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
              <div className="relative">
                <img 
                  ...
                  alt="Our Story" 
                  className="w-full h-[300px] lg:h-[600px] object-cover rounded-2xl shadow-2xl"
                />
            ...
            <div className={`transition-all duration-1000 delay-300 ${storyVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
              <h2 className="text-2xl sm:text-3xl lg:text-5xl font-black text-slate-900 mb-4 lg:mb-6">
                Our Story
              </h2>
              ...
              <button className="group bg-slate-900 hover:bg-slate-800 text-white px-6 py-3 lg:px-8 lg:py-4 rounded-lg font-bold text-sm lg:text-base transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center space-x-2">
      ...
      {/* Mission, Vision, Values - Fixed for mobile */}
      <section id="values-section" className="py-16 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Mission & Vision Cards */}
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 mb-16 lg:mb-20">
            <div className={`bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl p-6 lg:p-10 shadow-2xl transition-all duration-1000 ${valuesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="w-12 h-12 lg:w-16 lg:h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-4 lg:mb-6">
                <Target className="h-6 w-6 lg:h-8 lg:w-8 text-white" />
              </div>
              <h3 className="text-2xl lg:text-3xl font-black text-white mb-4">Our Mission</h3>
            ...
            <div className={`bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 lg:p-10 shadow-2xl transition-all duration-1000 delay-200 ${valuesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="w-12 h-12 lg:w-16 lg:h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-4 lg:mb-6">
                <Star className="h-6 w-6 lg:h-8 lg:w-8 text-white" />
              </div>
              <h3 className="text-2xl lg:text-3xl font-black text-white mb-4">Our Vision</h3>
              <p className="text-white/90 text-base lg:text-lg leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-4 lg:gap-6">
              {whatWeDo.map((item, index) => {
                ...
                return (
                  <div 
                    key={index} 
                    className={`bg-white rounded-2xl p-6 lg:p-8 border-2 ${colors.border} hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 ${valuesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                    style={{ transitionDelay: `${delay}ms` }}
                  >
                    <div className={`w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br ${colors.gradient} rounded-xl flex items-center justify-center mb-4 lg:mb-5`}>
                      <item.icon className="h-6 w-6 lg:h-7 lg:w-7 text-white" />
                    </div>
                    <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">{item.title}</h4>
          ...
          {/* Core Values Grid */}
          <div>
            <h3 className="text-2xl lg:text-3xl font-black text-slate-900 mb-6 lg:mb-8 text-center">Our Core Values</h3>
            <p className="text-base lg:text-lg text-gray-600 text-center max-w-2xl mx-auto mb-8 lg:mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {values.map((value, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br ${colors.gradient} rounded-xl flex items-center justify-center mb-4 lg:mb-5`}>
                      <value.icon className="h-6 w-6 lg:h-7 lg:w-7 text-white" />
                    </div>
                    <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">{value.title}</h4>
      ...
      <section id="impact-section" className="py-16 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {impactMetrics.map((metric, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`bg-white rounded-2xl p-6 lg:p-8 shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 ${impactVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                  style={{ transitionDelay: `${delay}ms` }}
                >
                  <div className="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl flex items-center justify-center mb-4 lg:mb-5">
                    <metric.icon className="h-6 w-6 lg:h-7 lg:w-7 text-white" />
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">{metric.metric}</h4>
      ...
      {/* Facilities Section - Fixed for mobile */}
      <section id="facilities-section" className="py-16 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className={`transition-all duration-1000 ${facilitiesVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
              <div className="inline-flex items-center space-x-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-6">
                <Map className="h-4 w-4 lg:h-5 lg:w-5 text-blue-600" />
                <span className="text-xs lg:text-sm font-semibold text-blue-600 tracking-wide">OUR FACILITIES</span>
              </div>
              ...
              <div className="space-y-3 lg:space-y-4">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 lg:h-6 lg:w-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-bold text-slate-900 text-sm lg:text-base">Liberty Stadium</p>
                    <p className="text-gray-600 text-xs lg:text-sm">Primary training facility with professional-grade pitches</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 lg:h-6 lg:w-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-bold text-slate-900 text-sm lg:text-base">Adamasingba Ground</p>
                    <p className="text-gray-600 text-xs lg:text-sm">Planned expansion for additional training opportunities</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 lg:h-6 lg:w-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-bold text-slate-900 text-sm lg:text-base">Selected Partner Pitches</p>
                    <p className="text-gray-600 text-xs lg:text-sm">Strategic locations across Ibadan for flexible training</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Sponsorship Section - Fixed for mobile */}
      <section className="py-16 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 lg:p-16 shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="relative grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                <div className="inline-flex items-center space-x-2 bg-yellow-500/10 border border-yellow-500/20 rounded-full px-4 py-2 mb-6">
                  <Briefcase className="h-4 w-4 lg:h-5 lg:w-5 text-yellow-500" />
                  <span className="text-xs lg:text-sm font-semibold text-yellow-500 tracking-wide">PARTNERSHIPS</span>
                </div>

                <h2 className="text-2xl lg:text-4xl font-black text-white mb-4 lg:mb-6">
              ...
              <div className="grid grid-cols-2 gap-3 lg:gap-4">
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 lg:p-6 border border-white/10">
                  <Trophy className="h-6 w-6 lg:h-8 lg:w-8 text-yellow-500 mb-2 lg:mb-3" />
                  <p className="text-white font-semibold text-sm lg:text-base mb-1">Player Development</p>
                  <p className="text-gray-400 text-xs lg:text-sm">Training & coaching support</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 lg:p-6 border border-white/10">
                  <Users className="h-6 w-6 lg:h-8 lg:w-8 text-blue-500 mb-2 lg:mb-3" />
                  <p className="text-white font-semibold text-sm lg:text-base mb-1">Kit & Travel</p>
                  <p className="text-gray-400 text-xs lg:text-sm">Equipment & logistics</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 lg:p-6 border border-white/10">
                  <Map className="h-6 w-6 lg:h-8 lg:w-8 text-green-500 mb-2 lg:mb-3" />
                  <p className="text-white font-semibold text-sm lg:text-base mb-1">Pitch Rentals</p>
                  <p className="text-gray-400 text-xs lg:text-sm">Facility access funding</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 lg:p-6 border border-white/10">
                  <BookOpen className="h-6 w-6 lg:h-8 lg:w-8 text-purple-500 mb-2 lg:mb-3" />
                  <p className="text-white font-semibold text-sm lg:text-base mb-1">Scholarships</p>
                  <p className="text-gray-400 text-xs lg:text-sm">Educational support</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Leadership Team - Fixed for mobile */}
      <section id="team-section" className="py-16 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-5xl font-black text-slate-900 mb-4 lg:mb-6">
  ...
  <div className="relative h-64 lg:h-80 overflow-hidden">
                    <img 
                      src={leader.image} 
                      alt={leader.name}
                      className="w-full h-full object-cover object-top transform group-hover:scale-120 transition-transform duration-700"
                    />
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <a href={leader.linkedin} className="w-8 h-8 lg:w-10 lg:h-10 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-colors">
                        <Linkedin className="h-4 w-4 lg:h-5 lg:w-5 text-slate-900" />
                      </a>
                      <a href={`mailto:${leader.email}`} className="w-8 h-8 lg:w-10 lg:h-10 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-colors">
                        <Mail className="h-4 w-4 lg:h-5 lg:w-5 text-slate-900" />
                      </a>
                    </div>
                  </div>
                  
                  <div className="p-4 lg:p-6">
                    <h3 className="text-lg lg:text-xl font-bold text-slate-900 mb-1">{leader.name}</h3>
                    <p className="text-yellow-600 font-semibold text-sm lg:text-base mb-2 lg:mb-3">{leader.role}</p>
                    <p className="text-gray-600 text-xs lg:text-sm leading-relaxed">{leader.bio}</p>
                  </div>
                </div>
              )
            })}
      ...
      {/* Get Involved Section - Fixed for mobile */}
      <section className="py-16 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-yellow-500/10 rounded-xl flex items-center justify-center mb-4 lg:mb-5">
                <Users className="h-6 w-6 lg:h-7 lg:w-7 text-yellow-600" />
              </div>
              <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Parents</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-blue-500/10 rounded-xl flex items-center justify-center mb-4 lg:mb-5">
                <Trophy className="h-6 w-6 lg:h-7 lg:w-7 text-blue-600" />
              </div>
              <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Coaches</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-green-500/10 rounded-xl flex items-center justify-center mb-4 lg:mb-5">
                <Briefcase className="h-6 w-6 lg:h-7 lg:w-7 text-green-600" />
              </div>
              <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Sponsors</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-purple-500/10 rounded-xl flex items-center justify-center mb-4 lg:mb-5">
                <Heart className="h-6 w-6 lg:h-7 lg:w-7 text-purple-600" />
              </div>
              <h4 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Volunteers</h4>
      ...
      <section className="py-16 lg:py-32 bg-slate-900 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center space-x-2 bg-yellow-500/10 border border-yellow-500/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-xs lg:text-sm font-semibold text-yellow-500 tracking-wide">JOIN US TODAY</span>
          </div>
          ...
          <p className="text-base lg:text-xl text-gray-300 max-w-2xl mx-auto mb-8 lg:mb-10 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-3 lg:gap-4">
            <button className="group bg-yellow-500 hover:bg-yellow-600 text-slate-900 px-6 py-3 lg:px-10 lg:py-5 rounded-lg font-bold text-sm lg:text-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105 flex items-center space-x-2">
              <span>Schedule a Visit</span>
              <ArrowRight className="h-4 w-4 lg:h-5 lg:w-5 group-hover:translate-x-1 transition-transform" />
            </button>
            
            <button className="group bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white px-6 py-3 lg:px-10 lg:py-5 rounded-lg font-bold text-sm lg:text-lg transition-all duration-300 border-2 border-white/20 hover:border-white/40">
