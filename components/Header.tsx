        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-10">
            ...
            <div className="flex items-center space-x-2">
              <a href="https://shrtlink.ai/NPA" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-slate-700 hover:bg-yellow-500 transition rounded flex items-center justify-center">
                <Facebook className="h-4 w-4 text-white" />
              </a>
              <a href="https://clik.now/TVX2" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-slate-700 hover:bg-yellow-500 transition rounded flex items-center justify-center">
                <Twitter className="h-4 w-4 text-white" />
              </a>
              <a href="https://clik.now/sHt6" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-slate-700 hover:bg-yellow-500 transition rounded flex items-center justify-center">
                <Instagram className="h-4 w-4 text-white" />
              </a>
              <a href="https://clik.now/PSei" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-slate-700 hover:bg-yellow-500 transition rounded flex items-center justify-center">
      ...
      <div className="border-b border-yellow-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20 gap-4">
            <Link href="/" className="flex items-center gap-3 flex-shrink-0 min-w-0 -ml-2">
            ...
            <div className="hidden lg:flex items-center flex-1 justify-end gap-10">
              <nav className="flex items-center gap-1 ml-[140px]">
